    ...
    <div className="flex flex-col h-screen bg-gray-900 text-white relative">
      ...
      <div className="flex-1 overflow-y-auto p-3 md:p-4 space-y-3">
        {conversations?.map((eachMessage, i) => {
          ...
          return (
            <div key={i} className={`flex w-[80%] ${isMine ? "justify-end" : "justify-start"}`}>
              <div className="relative w-full sm:max-w-md md:max-w-md">
                <div className={`p-2 md:p-3 rounded-2xl w-full ${isMine ? "bg-blue-600 text-white rounded-br-none" : "bg-gray-700 text-gray-100 rounded-bl-none"}`}>
                  ...
                  {eachMessage?.voiceUrl && <audio controls className="mt-2 w-full" src={eachMessage.voiceUrl}/>}
